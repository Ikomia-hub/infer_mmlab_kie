...
# --------------------
class InferMmlabKieWidget(core.CWorkflowTaskWidget):
...
# --------------------
class InferMmlabKieWidgetFactory(dataprocess.CWidgetFactory):

    def __init__(self):
        dataprocess.CWidgetFactory.__init__(self)
        # Set the name of the process -> it must be the same as the one declared in the process factory class
        self.name = "infer_mmlab_kie"

    def create(self, param):
        # Create widget object
        return InferMmlabKieWidget(param, None)
